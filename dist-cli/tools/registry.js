...
export class ToolRegistry {
     ...
     */
    trackExecutionTime(toolId, startTime) {
        const entry = this.state.tools.get(toolId);
        if (entry) {
 ...
 */
export const registerTool = (definition) => toolRegistry.register(definition);
export const unregisterTool = (toolId) => toolRegistry.unregister(toolId);
export const getTool = (toolId) => toolRegistry.get(toolId);
export const listTools = (options) => toolRegistry.list(options);
export const updateStatus = (toolId, status) => toolRegistry.updateStatus(toolId, status);
export const enableTool = (toolId) => toolRegistry.updateStatus(toolId, 'enabled');
export const disableTool = (toolId) => toolRegistry.updateStatus(toolId, 'disabled');
export const recordUsage = (toolId) => toolRegistry.recordUsage(toolId);
export const onToolEvent = (eventType, handler) => toolRegistry.on(eventType, handler);
