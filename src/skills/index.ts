...
export type { SkillAnalysisResult, SkillRequest } from './skill-creator.js';
 ...
 */
export const DEFAULT_INSTALL_OPTIONS: Required<InstallOptions> = {
  version: '',
 ...
 */
export const DEFAULT_SKILL_CONFIG: Record<string, Record<string, unknown>> = {
